...
// CLSID used for toast activation (must match shortcut ToastActivatorCLSID)
// TODO: Allow overriding via API / user configuration.
inline constexpr wchar_t kElectronToastActivatorClsid[] =
    L"{9E0A8B8F-6F2B-4C63-B5F0-9B1F3F8E4D1A}";
